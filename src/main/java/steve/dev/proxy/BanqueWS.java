 ...
 * 
 */
@WebServiceClient(name = "BanqueWS", targetNamespace = "http://ws.dev.steve/", wsdlLocation = "http://localhost:9191/BanqueWS?wsdl")
    ...
    extends Service
{
    ...
    private final static QName BANQUEWS_QNAME = new QName("http://ws.dev.steve/", "BanqueWS");
    ...
    public BanqueService getBanqueServicePort() {
        return super.getPort(new QName("http://ws.dev.steve/", "BanqueServicePort"), BanqueService.class);
    }
    ...
    public BanqueService getBanqueServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://ws.dev.steve/", "BanqueServicePort"), BanqueService.class, features);
    }
