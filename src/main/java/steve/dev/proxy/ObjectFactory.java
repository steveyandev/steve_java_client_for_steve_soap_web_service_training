 ...
 * generated in the steve.dev.proxy package. 
...
public class ObjectFactory {
    ...
    private final static QName _Convert_QNAME = new QName("http://ws.dev.steve/", "Convert");
    private final static QName _ConvertResponse_QNAME = new QName("http://ws.dev.steve/", "ConvertResponse");
    private final static QName _Compte_QNAME = new QName("http://ws.dev.steve/", "compte");
    private final static QName _Getcompte_QNAME = new QName("http://ws.dev.steve/", "getcompte");
    private final static QName _GetcompteResponse_QNAME = new QName("http://ws.dev.steve/", "getcompteResponse");
    private final static QName _ListComptes_QNAME = new QName("http://ws.dev.steve/", "listComptes");
    private final static QName _ListComptesResponse_QNAME = new QName("http://ws.dev.steve/", "listComptesResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: steve.dev.proxy
     * 
     */
     ...
     */
    @XmlElementDecl(namespace = "http://ws.dev.steve/", name = "Convert")
     ...
     */
    @XmlElementDecl(namespace = "http://ws.dev.steve/", name = "ConvertResponse")
     ...
     */
    @XmlElementDecl(namespace = "http://ws.dev.steve/", name = "compte")
     ...
     */
    @XmlElementDecl(namespace = "http://ws.dev.steve/", name = "getcompte")
     ...
     */
    @XmlElementDecl(namespace = "http://ws.dev.steve/", name = "getcompteResponse")
     ...
     */
    @XmlElementDecl(namespace = "http://ws.dev.steve/", name = "listComptes")
     ...
     */
    @XmlElementDecl(namespace = "http://ws.dev.steve/", name = "listComptesResponse")
